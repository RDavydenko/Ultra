...
namespace Ultra.Core.Web.Authorization.Attributes
{
    ...
    public class RoleRequiredAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var isAuthorized = _requiredRoles.All(requiredRole => roles.Contains(requiredRole));
            if (!isAuthorized)
            {
